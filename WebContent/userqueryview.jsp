    ...
    <!--  Free CSS Templates by TemplateMo.com  -->
   	  <div class="templatemo_container">
        	...
        	<div id="templatemo_header">
            	...
            	<div align="center"><font color="darkblue" style="font-size:50px;align:right;">User View</font>
                </div>
	            	    </div>
                <div id="templatemo_header_bottomAP">
                	<div id="templatemo_menuAP">
                    	<ul>
							...
							<li><a href="userquery.jsp"><b> User Query </b></a></li>
                            <li><a href="userqueryview.jsp"><b>Query View</b></a></li>
            ...
            <div id="templatemo_contentOV">
            	<div id="templatemo_content_leftO">
                	<div class="templatemo_postO">
                    	
						 <table width="100%" align="center" cellpadding ="1px" cellspacing="0" border="1px"> 
					 <tr align="center">
					 	<td colspan="5"><font color="black"  size="5"><strong>  User Query View</strong></font></td>
					 </tr>
  
                       <tr> 
       
           <!--<td><font color="black" size="4"><strong>Username</strong></font></td>   -->         
           <td><font color="black" size="4"><strong>Field Name</strong></font></td>
           <td><font color="black" size="4"><strong>City</strong></font></td>
             <td ><font color="black" size="4"><strong>Message</strong></font></td>
           <td><font color="black" size="4"><strong>Image</strong></font></td>
                  ...
                  <%
					 ...
					 try
					 {
						 ...
						 while(rs.next())
						 {
							 %>
						   <tr>
						  <!--<td><b><font color="darkblue"> <%=rs.getString("Uname")%></font></b></td>  --> 
							<td><b><font color="darkblue"><%=rs.getString("Fieldname")%></font></b></td> 
							 <td><b><font color="darkgreen"><%=rs.getString("City")%></font></b></td>
							...
							<td><b><font color="black"><%=rs.getString("Suggestion")%></font></b></td>
						  </tr>
                        ...
                        <div class="templatemo_section_1_midUQ">
                        	<div class="templatemo_form">
                                <form method="post" action="user.jsp">
                                    <img src="images/student_working_on_laptop_anim_500_clr_1849-1.gif" width="250" height="140">
                                </form>
