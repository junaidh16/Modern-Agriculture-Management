		...
		<div class="templatemo_container">
			...
			<div id="templatemo_header">
				<div id="templatemo_logoAP">
					<div align="center">
						<font color="darkblue"
							style="font-size: 50px; align: right;">Admin Officer</font>
					</div>
				</div>
				...
				<div id="templatemo_content_leftAP">
					<div class="templatemo_post">
						<table width="100%" align="center" cellpadding="2px"
							...
							<tr align="center">
								<td colspan="9"><font color="black" size="4"><strong>
											OFFICER VIEW DETAILS </strong></font></td>
							</tr>

							<tr>

								<td><font color="black" size="4"><strong>User
											Name</strong></font></td>
								...
								<td><font color="black" size="4"><strong>Officer Name</strong></font></td>
					 ...
					 try
					 {
						 ...
						 while(rs.next())
						 {
							...
							<tr>
								...
								<td><b><center>
											<font color="black"><%=rs.getString("Fieldoffname")%></font>
										</center></b></td>
								<td><center>
										<b><font color="black"><%=rs.getString("Suggestion")%></font>
									</center>
									</b></td>
